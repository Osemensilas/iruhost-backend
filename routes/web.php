...
$router->post('/api/post-support-message', [ChatsController::class, 'postSupportReply']);
...
$router->post('/api/delete-mailcow-mail', [UserProducts::class, 'deleteEmailAccount']);
...
$router->post('/api/message-clients', [AdminOps::class, 'messageClients']);
...
$router->get('/api/support-details', [SupportController::class, 'suportDetails']);
