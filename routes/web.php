...
$router->get('/api/user-tickets?status=resolved', [ChatsController::class, 'getResolvedTicket']);
$router->get('/api/user-tickets?status=unresolved', [ChatsController::class, 'getUnresolvedTicket']);
