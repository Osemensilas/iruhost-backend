...
$router->get('/api/user-tickets?status=resolved', [ChatsController::class, 'getTicket']);
$router->get('/api/user-tickets?status=unresolved', [ChatsController::class, 'getTicket']);
